...
@RunWith(Suite.class)
@SuiteClasses({ BinaryAdditionTest.class, LinearSearchTest.class, SelectionSortTest.class, InsertionIncrementalSortTest.class, InsertionRecursiveSortTest.class, MergeSort1Test.class,
